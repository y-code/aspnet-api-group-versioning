...
using static Sample3.Controllers.WeatherForecastV1Controller;
...
namespace Sample3.Controllers
{
    ...
    public class WeatherForecastV1P11Controller
    {
        ...
        [HttpGet("{date}")]
        public IEnumerable<WeatherForecastV1> GetV1([FromRoute] string date) => _base.GetV1(date);

        [HttpGet]
        public IEnumerable<WeatherForecastV1> GetV1() => _base.GetV1();
    }
    ...
    public class WeatherForecastV1_1P11Controller
    {
        ...
        [HttpGet("{date}")]
        public IEnumerable<WeatherForecastV1_1> GetV1_1([FromRoute] string date) => _base.GetV1_1(date);

        [HttpGet]
        public IEnumerable<WeatherForecastV1_1> GetV1_1() => _base.GetV1_1();
    }
